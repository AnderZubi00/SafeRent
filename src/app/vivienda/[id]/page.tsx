...
import { GaleriaVivienda } from "@/components/vivienda/GaleriaVivienda";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {vivienda.fotos && vivienda.fotos.length > 0 ? (
              <GaleriaVivienda fotos={vivienda.fotos} titulo={vivienda.titulo} />
            ) : (
            ...
            {propietario && (
              <div>
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl ring-1 ring-slate-200">
                  <div className="h-14 w-14 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-700 ring-1 ring-indigo-200 shrink-0">
